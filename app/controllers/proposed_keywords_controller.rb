...
layout :green_web
  ...
  def show
		...
		searchSeq = false
		#set the following true if I want to search sequences of 2 or 3 words: currently None
		#to set this true run task searchIndex before to see if it returns any result! 
		#searchSeq = true
